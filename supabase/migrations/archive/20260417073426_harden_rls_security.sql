...
ALTER FUNCTION public.is_church_follower(bigint, uuid) SET search_path = public, pg_temp;
ALTER FUNCTION public.get_church_follower_status(bigint, uuid) SET search_path = public, pg_temp;
ALTER FUNCTION public.get_church_follower_count(bigint) SET search_path = public, pg_temp;
ALTER FUNCTION public.set_updated_at() SET search_path = public, pg_temp;
ALTER FUNCTION public.bump_update_count() SET search_path = public, pg_temp;
ALTER FUNCTION public.bump_amen_count() SET search_path = public, pg_temp;
